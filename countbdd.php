...
{   
$sql = "INSERT INTO contador (ip, fecha, hora, horau, diau, aniou) ";   
echo $sql.= "VALUES ('$ip','$fecha','$hora','$horau','$diau','$aniou')";   
...
$men=$men . "<tr>" . chr(10);   
$men=$men . "<td><font color=#000>Visitas:$visitas</font></td>" . chr(10);   
$men=$men . "</tr>" . chr(10);   
